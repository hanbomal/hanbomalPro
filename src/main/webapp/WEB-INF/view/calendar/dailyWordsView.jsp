...
<div class=" w3-container w3-padding" >
  ...
  <div class="w3-bar w3-black" style="width: 100%">
    ...
    <button class="w3-bar-item w3-button tablink" onclick="loadWordCloud(${fileName },${num });openSelect(event,'wordcloud')">많이 사용한 단어</button>
    <button class="w3-bar-item w3-button tablink" onclick="loadPie(${fileName },${num });openSelect(event,'pie')">대화 참여 비율</button> 
  ...
  <div id="wordcloud" class="w3-container w3-center w3-padding  selected" style="min-height: 300px;" >
	<br><br><br><br>
	<span class="w3-tag w3-white w3-border w3-center w3-margin-top">상단의 버튼을 눌러주세요.</span>
